...
const MicrowaveNonLink = () => {
  ...
  const { value } = ValidasiContext.nonLinkPage.table
  ...
  return (
    <div>
      <div>
        <Link to='/validasi/add-non-microwave' className="flex gap-2 hover:underline mt-[15px] text-sm pl-6 items-center">
