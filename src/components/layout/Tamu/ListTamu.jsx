          ...
          data.map((item) => (
            <tbody className='bg-white'>
              <tr key={item.id}>
                ...
                <td className='px-6 text-[#000000] text-center text-sm py-4 whitespace-nowrap'>{item.perusahaan}</td>
                <td className='px-6 text-[#000000] text-center text-sm py-4 whitespace-nowrap'>{item.kontak}</td>
                <td className='px-6 text-[#000000] text-center text-sm py-4 whitespace-nowrap'>{item.Keperluan}</td>
                <td className='px-6 text-[#000000] text-center text-sm py-4 whitespace-nowrap'>{item.layanan}</td>
