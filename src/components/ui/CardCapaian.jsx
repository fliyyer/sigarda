...
const CardCapaian = (props) => {
    ...
    return (
        <div className='flex flex-col relative bg-[#F6F8FF] rounded-[40px] py-[31px] px-[45px]'>
            <p className='text-base 2xl:text-[22px] mb-8 2xl:mb-[40px] text-[#5E5E5E] leading-[16px]'>{title}</p>
            <p className='text-[#457EFF] text-center my-2 md:my-6 2xl:my-[40px] text-5xl md:text-[68px] 2xl:text-[96px] font-bold leading-[16px]'>{persentase}</p>
            <p className='text-xl md:text-2xl 2xl:text-[32px] mt-8 2xl:mt-[39px] mb-5 2xl:mb-[23px] font-bold text-[#5E5E5E] leading-[16px]'>{value}</p>
